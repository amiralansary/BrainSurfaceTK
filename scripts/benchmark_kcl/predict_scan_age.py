...
PATH_TO_ROOT = osp.join(osp.dirname(osp.realpath(__file__)), '../../models', '..')
import sys
...
from models.pointnet.src.utils import dataKCL

from multiprocessing import cpu_count
from weighted_sampler import make_sampler

PATH_TO_ROOT = osp.join(osp.dirname(osp.realpath(__file__)), '../../models', '..') + '/'
PATH_TO_POINTNET = osp.join(osp.dirname(osp.realpath(__file__)), '../../models', '..', '..', 'models', 'pointnet') + '/'

PATH_TO_FILES = '/vol/biomedic3/aa16914/dhcp_brain_emma/data/age_prediction/birth_age/data_splits'
...
if __name__ == '__main__':
    ...
    train_dataset, test_dataset, validation_dataset, train_loader, test_loader, val_loader, num_labels = dataKCL(
